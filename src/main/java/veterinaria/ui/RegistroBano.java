...
public class RegistroBano extends JFrame {
    ...
    public RegistroBano(List<String> mascotasRegistradas) {
        this.mascotasRegistradas = mascotasRegistradas;
        setTitle("Registro de Baño");
        setSize(800, 500);
        ...
        btnRegistrarBano = new JButton("Registrar Baño");
        btnRegistrarBano.setEnabled(false);
        btnRegistrarBano.addActionListener(e -> registrarBano());

        JPanel panelBotones = new JPanel();
        panelBotones.add(btnBuscar);
        panelBotones.add(btnRegistrarBano);
    ...
    private void verificarSeleccion() {
        btnRegistrarBano.setEnabled(clienteSeleccionado != null && mascotaSeleccionada != null);
    }

    private void registrarBano() {
        if (clienteSeleccionado != null && mascotaSeleccionada != null) {
            mascotasRegistradas.add(mascotaSeleccionada);
            String mensaje = "Se ha registrado un baño para " + mascotaSeleccionada + " de " + clienteSeleccionado + ".";
